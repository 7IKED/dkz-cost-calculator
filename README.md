...
### 💰 DkZâ„¢ Cost Calculator — LLM & Infrastruktur
...
![Lines](https://img.shields.io/badge/Lines-368-ffb800?style=for-the-badge)
...
```mermaid
graph TB
    A[Cost Calculator] --> B[index.html]
    A --> C[style.css]
    A --> D[script.js]
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-cost-calculator.git

# Oeffnen
cd dkz-cost-calculator
